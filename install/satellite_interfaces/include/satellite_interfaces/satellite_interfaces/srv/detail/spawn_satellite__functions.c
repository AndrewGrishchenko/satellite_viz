...
satellite_interfaces__srv__SpawnSatellite_Request__init(satellite_interfaces__srv__SpawnSatellite_Request * msg)
{
  ...
  if (!rosidl_runtime_c__String__init(&msg->name)) {
    satellite_interfaces__srv__SpawnSatellite_Request__fini(msg);
    return false;
  }
  return true;
}
...
satellite_interfaces__srv__SpawnSatellite_Request__create()
{
  ...
  satellite_interfaces__srv__SpawnSatellite_Request * msg = (satellite_interfaces__srv__SpawnSatellite_Request *)allocator.allocate(sizeof(satellite_interfaces__srv__SpawnSatellite_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(satellite_interfaces__srv__SpawnSatellite_Request));
  bool success = satellite_interfaces__srv__SpawnSatellite_Request__init(msg);
  if (!success) {
...
satellite_interfaces__srv__SpawnSatellite_Request__Sequence__init(satellite_interfaces__srv__SpawnSatellite_Request__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  satellite_interfaces__srv__SpawnSatellite_Request * data = NULL;

  if (size) {
    data = (satellite_interfaces__srv__SpawnSatellite_Request *)allocator.zero_allocate(size, sizeof(satellite_interfaces__srv__SpawnSatellite_Request), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = satellite_interfaces__srv__SpawnSatellite_Request__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        satellite_interfaces__srv__SpawnSatellite_Request__fini(&data[i - 1]);
      }
...
satellite_interfaces__srv__SpawnSatellite_Request__Sequence__fini(satellite_interfaces__srv__SpawnSatellite_Request__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      satellite_interfaces__srv__SpawnSatellite_Request__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  satellite_interfaces__srv__SpawnSatellite_Request__Sequence * array = (satellite_interfaces__srv__SpawnSatellite_Request__Sequence *)allocator.allocate(sizeof(satellite_interfaces__srv__SpawnSatellite_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = satellite_interfaces__srv__SpawnSatellite_Request__Sequence__init(array, size);
  if (!success) {
...
satellite_interfaces__srv__SpawnSatellite_Request__Sequence__destroy(satellite_interfaces__srv__SpawnSatellite_Request__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    satellite_interfaces__srv__SpawnSatellite_Request__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
satellite_interfaces__srv__SpawnSatellite_Request__Sequence__are_equal(const satellite_interfaces__srv__SpawnSatellite_Request__Sequence * lhs, const satellite_interfaces__srv__SpawnSatellite_Request__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!satellite_interfaces__srv__SpawnSatellite_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  satellite_interfaces__srv__SpawnSatellite_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(satellite_interfaces__srv__SpawnSatellite_Request);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    satellite_interfaces__srv__SpawnSatellite_Request * data =
      (satellite_interfaces__srv__SpawnSatellite_Request *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!satellite_interfaces__srv__SpawnSatellite_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          satellite_interfaces__srv__SpawnSatellite_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!satellite_interfaces__srv__SpawnSatellite_Request__copy(
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  satellite_interfaces__srv__SpawnSatellite_Response * msg = (satellite_interfaces__srv__SpawnSatellite_Response *)allocator.allocate(sizeof(satellite_interfaces__srv__SpawnSatellite_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(satellite_interfaces__srv__SpawnSatellite_Response));
  bool success = satellite_interfaces__srv__SpawnSatellite_Response__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
satellite_interfaces__srv__SpawnSatellite_Response__destroy(satellite_interfaces__srv__SpawnSatellite_Response * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    satellite_interfaces__srv__SpawnSatellite_Response__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
satellite_interfaces__srv__SpawnSatellite_Response__Sequence__init(satellite_interfaces__srv__SpawnSatellite_Response__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  satellite_interfaces__srv__SpawnSatellite_Response * data = NULL;

  if (size) {
    data = (satellite_interfaces__srv__SpawnSatellite_Response *)allocator.zero_allocate(size, sizeof(satellite_interfaces__srv__SpawnSatellite_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = satellite_interfaces__srv__SpawnSatellite_Response__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        satellite_interfaces__srv__SpawnSatellite_Response__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
satellite_interfaces__srv__SpawnSatellite_Response__Sequence__fini(satellite_interfaces__srv__SpawnSatellite_Response__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      satellite_interfaces__srv__SpawnSatellite_Response__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  satellite_interfaces__srv__SpawnSatellite_Response__Sequence * array = (satellite_interfaces__srv__SpawnSatellite_Response__Sequence *)allocator.allocate(sizeof(satellite_interfaces__srv__SpawnSatellite_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = satellite_interfaces__srv__SpawnSatellite_Response__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
satellite_interfaces__srv__SpawnSatellite_Response__Sequence__destroy(satellite_interfaces__srv__SpawnSatellite_Response__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    satellite_interfaces__srv__SpawnSatellite_Response__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
satellite_interfaces__srv__SpawnSatellite_Response__Sequence__are_equal(const satellite_interfaces__srv__SpawnSatellite_Response__Sequence * lhs, const satellite_interfaces__srv__SpawnSatellite_Response__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!satellite_interfaces__srv__SpawnSatellite_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  satellite_interfaces__srv__SpawnSatellite_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(satellite_interfaces__srv__SpawnSatellite_Response);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    satellite_interfaces__srv__SpawnSatellite_Response * data =
      (satellite_interfaces__srv__SpawnSatellite_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!satellite_interfaces__srv__SpawnSatellite_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          satellite_interfaces__srv__SpawnSatellite_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!satellite_interfaces__srv__SpawnSatellite_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
satellite_interfaces__srv__SpawnSatellite_Event__init(satellite_interfaces__srv__SpawnSatellite_Event * msg)
{
  ...
  if (!service_msgs__msg__ServiceEventInfo__init(&msg->info)) {
    satellite_interfaces__srv__SpawnSatellite_Event__fini(msg);
    return false;
  }
  // request
  if (!satellite_interfaces__srv__SpawnSatellite_Request__Sequence__init(&msg->request, 0)) {
    satellite_interfaces__srv__SpawnSatellite_Event__fini(msg);
    return false;
  }
  // response
  if (!satellite_interfaces__srv__SpawnSatellite_Response__Sequence__init(&msg->response, 0)) {
    satellite_interfaces__srv__SpawnSatellite_Event__fini(msg);
    return false;
  }
  return true;
...
satellite_interfaces__srv__SpawnSatellite_Event__fini(satellite_interfaces__srv__SpawnSatellite_Event * msg)
{
  ...
  // request
  satellite_interfaces__srv__SpawnSatellite_Request__Sequence__fini(&msg->request);
  // response
  satellite_interfaces__srv__SpawnSatellite_Response__Sequence__fini(&msg->response);
}
...
satellite_interfaces__srv__SpawnSatellite_Event__are_equal(const satellite_interfaces__srv__SpawnSatellite_Event * lhs, const satellite_interfaces__srv__SpawnSatellite_Event * rhs)
{
  ...
  // request
  if (!satellite_interfaces__srv__SpawnSatellite_Request__Sequence__are_equal(
      &(lhs->request), &(rhs->request)))
  {
    return false;
  }
  // response
  if (!satellite_interfaces__srv__SpawnSatellite_Response__Sequence__are_equal(
  ...
  satellite_interfaces__srv__SpawnSatellite_Event * output)
{
  ...
  // request
  if (!satellite_interfaces__srv__SpawnSatellite_Request__Sequence__copy(
      &(input->request), &(output->request)))
  {
    return false;
  }
  // response
  if (!satellite_interfaces__srv__SpawnSatellite_Response__Sequence__copy(
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  satellite_interfaces__srv__SpawnSatellite_Event * msg = (satellite_interfaces__srv__SpawnSatellite_Event *)allocator.allocate(sizeof(satellite_interfaces__srv__SpawnSatellite_Event), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(satellite_interfaces__srv__SpawnSatellite_Event));
  bool success = satellite_interfaces__srv__SpawnSatellite_Event__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
satellite_interfaces__srv__SpawnSatellite_Event__Sequence__init(satellite_interfaces__srv__SpawnSatellite_Event__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  satellite_interfaces__srv__SpawnSatellite_Event * data = NULL;

  if (size) {
    data = (satellite_interfaces__srv__SpawnSatellite_Event *)allocator.zero_allocate(size, sizeof(satellite_interfaces__srv__SpawnSatellite_Event), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = satellite_interfaces__srv__SpawnSatellite_Event__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        satellite_interfaces__srv__SpawnSatellite_Event__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
satellite_interfaces__srv__SpawnSatellite_Event__Sequence__fini(satellite_interfaces__srv__SpawnSatellite_Event__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      satellite_interfaces__srv__SpawnSatellite_Event__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  satellite_interfaces__srv__SpawnSatellite_Event__Sequence * array = (satellite_interfaces__srv__SpawnSatellite_Event__Sequence *)allocator.allocate(sizeof(satellite_interfaces__srv__SpawnSatellite_Event__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = satellite_interfaces__srv__SpawnSatellite_Event__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
satellite_interfaces__srv__SpawnSatellite_Event__Sequence__destroy(satellite_interfaces__srv__SpawnSatellite_Event__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    satellite_interfaces__srv__SpawnSatellite_Event__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
satellite_interfaces__srv__SpawnSatellite_Event__Sequence__are_equal(const satellite_interfaces__srv__SpawnSatellite_Event__Sequence * lhs, const satellite_interfaces__srv__SpawnSatellite_Event__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!satellite_interfaces__srv__SpawnSatellite_Event__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  satellite_interfaces__srv__SpawnSatellite_Event__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(satellite_interfaces__srv__SpawnSatellite_Event);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    satellite_interfaces__srv__SpawnSatellite_Event * data =
      (satellite_interfaces__srv__SpawnSatellite_Event *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!satellite_interfaces__srv__SpawnSatellite_Event__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          satellite_interfaces__srv__SpawnSatellite_Event__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!satellite_interfaces__srv__SpawnSatellite_Event__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
